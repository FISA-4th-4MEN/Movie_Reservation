...
![image](https://github.com/user-attachments/assets/33fe0f34-fd76-4c3c-883a-a8e152f66ee0)
...
<img src="https://img.shields.io/badge/VirtualBox-BE3939?style=for-the-badge&logo=VirtualBox&logoColor=white"> <img src="https://img.shields.io/badge/MobaxTerm-00B14F?style=for-the-badge&logo=MobaxTerm&logoColor=white"> <img src="https://img.shields.io/badge/Linux-23C8D2?style=for-the-badge&logo=Linux&logoColor=white"> <img src="https://img.shields.io/badge/DBeaver-293239?style=for-the-badge&logo=DBeaver&logoColor=white"> <img src="https://img.shields.io/badge/MySQL-855DCD?style=for-the-badge&logo=MySQL&logoColor=white">
...
- 문제에 대한 DB 생성은 github에 기재된 sql 파일을 사용해주세요.
...
- 전체 이용가였던 영화 시리즈들이 19세 이상 관람 가능으로 바뀌었습니다. 예매 취소 통보를 하기 위해 바뀌기 전에 예매했던 사람들 중 19세 미만인 사람들을 검색해주세요. (형변환 함수: CAST())
- 출력 예시
...
- nate 이메일과 전화번호 3자리 서비스를 종료한다고 합니다. 해당
...
### 💡 정파란
단순히 sql 문장만을 뽑아내는것이 아니고, 도메인 선정, 공용 DB 세팅, 데이터베이스 테이블 선정, 연관성 있는 데이터 입력 등 모든 과정을 진행한 프로젝트였습니다. 
공용 DB 세팅에서 어려움을 겪었지만 한번 세팅방법을 알고 나니 앞으로의 프로젝트에서 자신감이 생겼고 팀원들과 다같이 데이터 베이스 설계를 하며 탄탄한 설계를 했다고 생각했습니다. 그러나 각 테이블에서의 변수명이
각자의 방법으로 작명되어 DML 파일 작성시에 많은 수정이 있었습니다. 테이블간의 관계 뿐 아니라 변수명까지도 명명 규칙들도 엄밀하게 정의하는것이 중요하다고 느꼈습니다.
실용적인 도메인을 활용하며 정규표현식이 다양한 기능에서 사용될 수 있음을 알았고 학습에 도움이 되었습니다. 

향후 네트워크 브릿지 방식을 사용하지 않고도 디비를 외부 가상머신에서도 접속할 수 있는 방법을 적용해봐야겠다 느꼈습니다.
